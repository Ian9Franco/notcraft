...
import { useIsMobile } from "@/hooks/use-mobile" // Asegúrate de que esta ruta sea correcta
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  const transformDirection = side === "left" ? "-translate-x-full" : "translate-x-full"
...
return (
  <div
    ...
    data-side={side}
  >
    {/* Placeholder para mantener el gap */}
    <div
      className={cn(
    ...
    <div
      className={cn(
        "fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] md:flex bg-sidebar text-sidebar-foreground",
    ...
    return (
      <main
        ...
        className={cn(
          ...
          // ⚙️ Reservar espacio para Sidebar solo si NO está collapsed
          "peer-data-[state=expanded]:md:pl-[var(--sidebar-width)] peer-data-[state=collapsed]:md:pl-[var(--sidebar-width-icon)]",
          // Si usas `side="right"` cámbialo a `pr`!
