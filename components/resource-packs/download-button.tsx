...
interface DownloadButtonProps {
  ...
  className?: string
  onComplete?: () => void
  bucket?: string // Nuevo parámetro para especificar el bucket
}

/**
 * Componente para descargar archivos de Supabase Storage sin recargar la página
...
export default function DownloadButton({
  ...
  className = "",
  onComplete,
  bucket = "resource-packs", // Por defecto usa el bucket de resource-packs
}: DownloadButtonProps) {
  ...
  return (
    <div className="relative">
      <GameButton
        variant={status === "error" ? "primary" : status === "success" ? "accent" : variant}
        size={size}
        fullWidth={fullWidth}
        className={className}
